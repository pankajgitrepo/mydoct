...
namespace mojoPortal.Business
{
	...
	public class Role
	{
	    ...
	    public const string AuthenticatedUserRole = "Authenticated Users";
		...
		private bool Update()
		{
			return DBRoles.Update(this.roleID,this.displayName, this.IsC21Role);
		}
        ...
        public static Collection<Role> GetbySite(int siteId)
        {
            ...
            using (IDataReader reader = DBRoles.GetSiteRoles(siteId))
            {
                while (reader.Read())
                {
                    ...
                    if (reader["IsC21Role"] != System.DBNull.Value)
                    {

                        role.IsC21Role = (bool)reader["IsC21Role"];
                    }
        ...
        public static void AddUserToDefaultRoles(SiteUser siteUser)
        {
            ...
            Role role = new Role(siteUser.SiteId, Role.AuthenticatedUserRole);
            if (role.RoleId > -1)
            {
