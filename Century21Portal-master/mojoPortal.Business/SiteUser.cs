...
namespace mojoPortal.Business
{
	...
	public class SiteUser 
	{
        ...
        #region Custom Properties define for c21
        //Custom properties define for c21 SSO integration
    //    public string City { get; set; }
     ...
     //   public string AccountId { get; set; }
        ...
        #endregion Custom Properties define for c21
        ...
        public void GetUser(IDataReader reader)
        {
        ...
        public static List<SiteUser> LoadUsers(int siteId)
        {
            List<SiteUser> userList = new List<SiteUser>();
            
            using (IDataReader reader = SiteUser.GetUserList(siteId))
            {
                while (reader.Read())
                {
        ...
        /// <summary>
        /// Return users list those who are having Instructor role
        /// </summary>
        /// <param name="siteId"></param>
        /// <returns></returns>
        public static List<SiteUser> LoadInstructors(int siteId)
        {
            List<SiteUser> userList = new List<SiteUser>();

            using (IDataReader reader = SiteUser.GetInstructors(siteId))
            {
                while (reader.Read())
                {
                    SiteUser user = new SiteUser();
             ...
             switch (propertyName)
            {
                ...
                case "Address1":
                    if (propertyValue is String)
                        ...
                        this.Address1 = propertyValue.ToString();
                    this.Save();
                ...
                case "Address2":
                    if (propertyValue is String)
                        ...
                        this.Address2 = propertyValue.ToString();
                    this.Save();
                ...
                case "City":
                    if (propertyValue is String)
                        ...
                        this.City = propertyValue.ToString();
                    this.Save();
                ...
                case "Zip":
                    if (propertyValue is String)
                        ...
                        this.Zip = propertyValue.ToString();
                    this.Save();
        ...
        public static IDataReader GetInstructors(int siteId)
        {
            ...
            return DBSiteUser.GetInstructors(siteId);
        }
