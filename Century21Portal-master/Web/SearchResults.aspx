                ...
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    ...
                    <asp:Panel ID="pnlInternalSearch" runat="server" DefaultButton="btnDoSearch">
                        ...
                        <div class="settingrow searchcontrols">
                            ...
                            <asp:DropDownList ID="ddFeatureList" runat="server" Visible="false" CssClass="searchfeatures">
                            </asp:DropDownList>
                            ...
                            <span class="searchduration" style="display:none">
                        ...
                        <asp:Panel ID="pnlSearchResults" runat="server" Visible="False" CssClass="settingrow searchresults">
                            ...
                            <asp:Repeater ID="rptResults" runat="server" EnableViewState="False">
                                ...
                                <ItemTemplate>
                                    <li class="searchresult"  style='clear:both;'>
                                        ...
                                        <div class="searchresultdesc">
                                              <%#FormatSearchResultDesc(Eval("OtherContent").ToString(),Eval("Intro").ToString())%>
                                       </div>
                                    </li>
                                </ItemTemplate>
                                <FooterTemplate>
