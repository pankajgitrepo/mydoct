...
{
    public class T1OnlineLink : WebControl
    {
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["T1OnlineLink"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resource.T1OnlineLink);
