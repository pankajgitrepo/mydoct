    ...
    public class jDatePicker : TextBox
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            { 
                ...
                {
                    CssClass = "normaltextbox forminput datepicker widetextbox marginRight"; 
                }
        ...
        private void SetupScript()
        {
            ...
            {
                script.Append(",buttonImage: '" + Page.ResolveUrl("~/Data/SiteImages/calendar.gif") + "' ");
                //script.Append(",buttonImage: '" + Page.ResolveUrl(buttonImage) + "' ");
            }

            if (buttonImageOnly) { script.Append(",buttonImageOnly: true"); }
            script.Append(",buttonText:'Click to open calendar'");
        ...
        private string buttonImage = "Click";
        /// <summary>
        ...
        private bool buttonImageOnly = true;
