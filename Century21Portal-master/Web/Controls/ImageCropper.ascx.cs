    ...
    public partial class ImageCropper : UserControl
    {
        ...
        void btnCrop_Click(object sender, EventArgs e)
        {
            ...
            if (SiteUtils.IsImageFileExtension(ext))
            {
                ...
                if (fileSystem.FileExists(sourceImagePath))
                {
                    ...
                    if (finalMaxWidth > 0)
                    {
                        ...
                        lblCropImage.Text = Resource.UserProfileImgCropSuccess;
                        lblCropImage.ForeColor = System.Drawing.Color.Green;
                    }
            ...
            else
            {
                ...
                lblCropImage.Text = Resource.UserProfileImgCropFail;
                lblCropImage.ForeColor = System.Drawing.Color.Green;
            }
        ...
        private void PopulateLabels()
        {
            ...
            lblNote.Text = Resource.ImgCropNote;
            litCropHelpText.Text = Resource.CropHelpMessage;
          
          // lblImageUpload.Text = Resource.UserProfileImgUploadSuccess;
        }
