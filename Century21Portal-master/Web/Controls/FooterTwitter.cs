...
{
    public class FooterTwitter : WebControl
    {
        ...
        private string imageUrl = SiteUtils.GetNavigationSiteRoot() + "/Data/Sites/1/skins/Theme_C21/images/footer_tweter.png";
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            if (CssClass.Length == 0) CssClass = "sitelink imgtwt";
            ...
            { //style='float: right;  margin-right: 48px;  margin-top: -8px;'
                writer.Write(string.Format(
                                 " <a href='{0}' class='"
                                 + CssClass + "'  title='{1}' target='_blank' ><img alt='{1}' src='{2}' /></a>",
                                 Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["Century21Twitter"]),
                                 Resource.FooterTwitterHover,
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["JoinUsLink"]));
