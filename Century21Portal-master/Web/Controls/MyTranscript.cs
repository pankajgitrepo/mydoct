...
{
    public class MyTranscript : WebControl
    {
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["MyTranscriptLink"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resource.MyTranscript);
