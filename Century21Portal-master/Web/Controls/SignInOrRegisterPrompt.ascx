...
<div class="floatpanel signinorregister-signinprompt">
    <asp:Literal ID="litLoginPrompt" runat="server" Visible="false" /><br class="brspacer" />
    <asp:HyperLink ID="lnkLogin" runat="server" Text="Login" CssClass="lnkLogin" />
</div>
<div class="floatpanel signinorregister-registerprompt" >
    <asp:Literal ID="litRegisterPrompt" runat="server" Visible="false" /><br class="brspacer" />
