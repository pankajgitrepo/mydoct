    ...
    public class Link : WebControl
    {
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["Link"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resources.Resource.Link);
