...
{
    public class FooterYouTube : WebControl
    {
        ...
        private string imageUrl = SiteUtils.GetNavigationSiteRoot() + "/Data/Sites/1/skins/Theme_C21/images/footer_youtube.png";
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            if (imageUrl.Length > 0)
            {
                writer.Write(string.Format(
                                 " <a href='{0}' class='"
                                 + CssClass + "' style='float: right;  margin-right: -98px;  margin-top: -8px;' title='{1}'><img alt='{1}' src='{2}' /></a>",
                                 Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["Century21Youtube"]),
                                 Resource.FooterYoutubeHover,
