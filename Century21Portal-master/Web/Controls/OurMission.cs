...
{
    public class OurMission : WebControl
    {
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["OurMission"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resources.Resource.OurMission);
