...
{
    public class RegistrationSiteLink : WebControl
    {
        ...
        {
            string urlToUse = SiteUtils.GetRelativeNavigationSiteRoot() + "/Contact";
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["RegistrationSiteLink"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resource.RegistrationSiteLink);
