...
{
    public class MyRegistrations : WebControl
    {
        ...
        private void DoRender(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.WriteAttribute("href", Page.ResolveUrl(System.Web.Configuration.WebConfigurationManager.AppSettings["MyRegistrationsLink"]));
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resource.MyRegistrations);
