...
{
    public class TermsOfUse : WebControl
    {
        ...
        {
            string urlToUse = SiteUtils.GetRelativeNavigationSiteRoot() + "/termsofuse";
            ...
            else
            {
                ...
                writer.Write(HtmlTextWriter.TagRightChar);
                writer.WriteEncodedText(Resources.Resource.TermsOfUse);
