        ...
        <div class="modulecontent">
            <fieldset>
                ...
                <div id="divtabs" class="mojo-tabs">
                    <ul>
                        <li id="liSecurity" runat="server" Visible="false"><asp:Literal ID="litSecurityTab" runat="server" /></li>
                        ...
                        <div id="tabSecurity" style="padding-top:10px;">
                        ...
                        <div id="tabProfile" runat="server" style="padding:0;">
                            <div class="settingrow usercreated" style="display:none">
                            ...
                            <div id="divSkin" runat="server" class="settingrow" Visible="False">
                ...
                <div class="settingrow">
                    ...
                    <asp:HyperLink ID="lnkChangePassword" runat="server" CssClass="passwordrecovery" Visible="false"></asp:HyperLink>
