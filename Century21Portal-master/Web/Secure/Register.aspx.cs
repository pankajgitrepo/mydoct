            ...
            if ((txtConfirm != null) && (txtPassword != null))
            {
                ...
                if (siteSettings.RequireEnterEmailTwiceOnRegistration)
                {
                    if (ConfirmEmail != null)
                    {
                        ...
                        if (pnlEmailConfirmHint != null) { pnlEmailConfirmHint.Visible = true; }
