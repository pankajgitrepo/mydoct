...
namespace mojoPortal.Web
{
    public static class WebConfigSettings
    {
        ...
        public static int MasterDataPageSize
        {
            get { return ConfigHelper.GetIntProperty("MasterDataPageSize", 15); }
        }
        ...
        public static string AllowedSkinFileExtensions
        {
            get
            {
                ...
                // default value
                return ".master|.skin|.css|.less|.jpg|.jpeg|.png|.gif|.ico|.txt|.config|.js|.swf|.flv|.fla|.html|.xml";
            }
        }
        ...
        {
            get { return ConfigHelper.GetStringProperty("FileDialogRelativeUrl", "/Dialog/FileDialog.aspx"); }
        }
        ...
        public static string PageToRedirectToAfterSignIn
        {
            get
            {
                ...
                {
                    string strPageToRedirectToAfterSignIn = ConfigurationManager.AppSettings["PageToRedirectToAfterSignIn"];
                    return strPageToRedirectToAfterSignIn;
                    //try
                    //{
                    ...
                    //    string hashValue = CryptoHelper.Hash(timeStamp + saltKey);
                    //    return string.Format(strPageToRedirectToAfterSignIn, timeStamp, hashValue);
                    //}
                    //catch
                    //{
                    //    return strPageToRedirectToAfterSignIn;
        ...
        public static string KalturaPlayVideoPageURL
        {
            get
            {
                if (ConfigurationManager.AppSettings["KalturaPlayVideosPageURL"] != null)
                {
                    return ConfigurationManager.AppSettings["KalturaPlayVideosPageURL"];
                }
                return string.Empty;
            }
        }
        ...
        public static string CoursesUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["CoursesUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["CoursesUrl"];
                }
        ...
        public static string CourseCommentsFeatureUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["CourseCommentsFeatureUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["CourseCommentsFeatureUrl"];
                }

                return string.Empty;
            }
        }
        public static string LikeBlueImageUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["LikeBlueImageUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["LikeBlueImageUrl"];
                }
        ...
        public static string LikeGrayImageUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["LikeGrayImageUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["LikeGrayImageUrl"];
                }
        ...
        public static string FavouriteGreyImageUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["FavouriteGreyImageUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["FavouriteGreyImageUrl"];
                }
        ...
        public static string FavouriteImageUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["FavouriteImageUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["FavouriteImageUrl"];
                }
        ...
        public static string ScheduleUrl
        {
            get
            {
                if (ConfigurationManager.AppSettings["ScheduleUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["ScheduleUrl"];
                }
        ...
        public static string CourseSearchUrl
        {
             get
            {
                if (ConfigurationManager.AppSettings["CourseSearchUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["CourseSearchUrl"];
                }
