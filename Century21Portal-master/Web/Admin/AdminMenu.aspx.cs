...
//#endif
            ...
            liMasterData.Visible = ((WebUser.IsInRoles(siteSettings.RolesThatCanCreateUsers)) || (WebUser.IsInRoles(siteSettings.RolesThatCanManageUsers)) || (WebUser.IsInRoles(siteSettings.RolesThatCanLookupUsers)));
            lnkMasterData.Text = Resource.MasterCourseDataLabel;
            lnkMasterData.NavigateUrl = SiteRoot + "/Admin/MasterData.aspx";
