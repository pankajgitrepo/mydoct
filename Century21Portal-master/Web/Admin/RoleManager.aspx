...
<div class="settingrow">
    <portal:mojoDataList id="rolesList" DataKeyField="RoleID" runat="server">
		...
		<EditItemTemplate>
			...
			&nbsp;  
            <mp:SiteLabel ID="lblActive" runat="server" ForControl="chkActive" ConfigKey="IsC21Role"></mp:SiteLabel>
            <asp:CheckBox ID="chkIsC21Role" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "IsC21Role") %>' CssClass="forminput" />
            &nbsp;
...
<asp:Panel ID="pnlAddRole" runat="server" CssClass="settingrow" DefaultButton="btnAddRole">
	...
	<asp:TextBox ID="txtNewRoleName" Runat="server" MaxLength="50" CssClass="mediumtextbox"></asp:TextBox>
      &nbsp; 
      <mp:SiteLabel ID="lblActive" runat="server" ForControl="chkActive"
                                        ConfigKey="IsC21Role"></mp:SiteLabel>
        <asp:CheckBox ID="chkIsC21Role" runat="server" CssClass="forminput" />
