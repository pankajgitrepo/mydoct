                ...
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    <div id="divtabs" class="mojo-tabs">
                        ...
                        <div id="tabGeneralSettings" runat="server">
                            ...
                            <div class="settingrow">
                                <mp:SiteLabel ID="SiteLabel11" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
                            </div>
                        </div>
                    ...
                    <div class="modulecontent">
                        ...
                        <div class="settingrow">
                            ...
                            &nbsp;
                            <span class="art-button" style="    padding-bottom: 10px; font-weight: 500; color: #ffffff;font-size: 16px;">
                                <asp:HyperLink ID="lnkCancel" runat="server" style="vertical-align:-webkit-baseline-middle" /></span>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="art-button" style="    padding-bottom: 10px; font-weight: 500; color: #ffffff;font-size: 16px;">
                                <asp:HyperLink ID="lnkEditContent" runat="server" Visible="false" EnableViewState="false" style="vertical-align:-webkit-baseline-middle" /></span>
                            &nbsp;
                            <span class="art-button" style="    padding-bottom: 10px; font-weight: 500; color: #ffffff;font-size: 16px;">
                                <asp:HyperLink ID="lnkPublishing" runat="server" Visible="false" EnableViewState="false" style="vertical-align:-webkit-baseline-middle"/>
                            </span>
                        </div>
                    </div>
