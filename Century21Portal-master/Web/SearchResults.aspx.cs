...
namespace mojoPortal.Web.UI.Pages
{
    ...
    public partial class SearchResults : NonCmsBasePage
	{
        ...
        protected string FormatSearchResultDesc(string ThumbnailURL, string Intro)
        {
            string tagcontent = String.Empty;

            if (!String.IsNullOrEmpty(ThumbnailURL))
            {
                tagcontent = "<div style='width:100%;'>" +
                        "<div class='videothumbnailurl'><img src='" + ThumbnailURL + "' /></div>"
                        + "<div class='videodesc'>" + Intro + "</div></div>";
        //        tagcontent = "<div style='width:100%;'>" +
        //"<div style='float:left;width:15%;'><img src='" + ThumbnailURL + "' /></div>"
        //+ "<div style='float:right;width:85%;'>" + Intro + "</div></div>";
            }
            else {
                tagcontent =Intro;
            }
