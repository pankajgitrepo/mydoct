...
namespace mojoPortal.Data
{
    ...
    public static class DBRoles
    {
        ...
        public static int RoleCreate(
            ...
            Guid siteGuid,
            int siteId,
            string roleName, bool isC21Role = false)
        {
            ...
            sph.DefineSqlParameter("@IsC21Role", SqlDbType.Bit, ParameterDirection.Input, isC21Role);            
            int newID = Convert.ToInt32(sph.ExecuteScalar());
            return newID;
        }

        public static bool Update(int roleId, string roleName, bool isC21Role)
        {
