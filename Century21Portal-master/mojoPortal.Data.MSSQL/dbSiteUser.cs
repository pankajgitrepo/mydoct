...
namespace mojoPortal.Data
{
    public static class DBSiteUser
    {
        ...
        public static IDataReader GetInstructors(int siteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "USP_Users_GetInstructors", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            return sph.ExecuteReader();
        }
            ...
            )
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Users_Insert", 28);
            ...
            #region Added custom properties for c21 sso

            if (city == null)
            {
                sph.DefineSqlParameter("@City", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value);
            }
            else
            {
                sph.DefineSqlParameter("@City", SqlDbType.NVarChar, ParameterDirection.Input, city);
            }

            if (address1 == null)
            {
                sph.DefineSqlParameter("@Address1", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value);
            }
            else
            {
                sph.DefineSqlParameter("@Address1", SqlDbType.NVarChar, ParameterDirection.Input, address1);
            }

            if (address2 == null)
            {
                sph.DefineSqlParameter("@Address2", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value);
            }
            else
            {
                sph.DefineSqlParameter("@Address2", SqlDbType.NVarChar, ParameterDirection.Input, address2);
            }

            if (zip == null)
            {
                sph.DefineSqlParameter("@Zip", SqlDbType.VarChar, ParameterDirection.Input, DBNull.Value);
            }
            else
            {
                sph.DefineSqlParameter("@Zip", SqlDbType.VarChar, ParameterDirection.Input, zip);
            }

            if (accountId == null)
            {
                sph.DefineSqlParameter("@AccountId", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value);
            }
            else
            {
                sph.DefineSqlParameter("@AccountId", SqlDbType.NVarChar, ParameterDirection.Input, accountId);
            }

            #endregion Added custom properties for c21 sso
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Users_Update", 54);
