...
<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
    ...
    <asp:Panel ID="pnlBlog" runat="server" DefaultButton="btnUpdate">
            <div id="divtabs" class="mojo-tabs">
                    ...
                    <div id="tabContent">
                        ...
                        <div class="settingrow">
                            ...
                            <asp:CheckBox ID="chkShowAuthorBio" runat="server" CssClass="forminput" Checked="true">
                                    ...
                                    <div class="settingrow" id="divSortOrder" runat="server" visible="true">
                <mp:SiteLabel ID="SiteLabel44" runat="server" ForControl="txtSortOrder" CssClass="settinglabel"
                ...
                <portal:mojoHelpLink ID="MojoHelpLink10" runat="server" HelpKey="forum--post-stickysort-help" />
            </div>
                        <div class="settingrow">
                        ...
                        <div class="settingrow">
                            ...
                            <div class="forminput">
                                ...
                                <asp:HyperLink ID="lnkCancel" runat="server" CssClass="art-button" />&nbsp;
                            </div>
                            <br />
