...
<blog:BlogPostListWrapperPanel ID="divblog" runat="server" CssClass="blogcenter-rightnav">
        ...
        <ItemTemplate>
            <blog:BlogPostListItemPanel id="bi1" runat="server" CssClass="blogitem">
                <<%# itemHeadingElement %> class="blogtitle">
                    <asp:HyperLink ID="lnkTitle" runat="server" EnableViewState="false" NavigateUrl='<%# FormatBlogTitleUrl(Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")))  %>'
                        Text='<%# Eval("Heading") %>' Visible='<%# Config.UseLinkForHeading %>'>                        
                    </asp:HyperLink>
                    <%--Below HyperLink lnkMore Added for More to Blog--%>
                   <%-- <asp:HyperLink id="lnkMore" runat="server" EnableViewState="false" CssClass="blogtitleMore" Text="More" Visible='<%# Config.UseLinkForHeading %>'
                        NavigateUrl='<%# FormatBlogTitleUrl(Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")))  %>'></asp:HyperLink>--%>
                    <asp:Literal ID="litTitle" runat="server" Text='<%# Eval("Heading") %>'
                ...
                <asp:Panel ID="pnlPost" runat="server" Visible='<%# !TitleOnly %>'>
                   ...
                   <portal:AddThisWidget ID="addThisWidget" runat="server" AccountId='<%# addThisAccountId %>' SkinID="BlogList" TitleOfUrlToShare='<%# DataBinder.Eval(Container.DataItem,"Heading") %>' 
                    ...
                    <div class="blogcommentlink">
                       ...
                       { %>
                    <div class="blogdate" style="float:left;">
                    ...
                    <% } %>
                        ...
                        <div class="fb-share-button" data-href='<%# FormatBlogUrl(DataBinder.Eval(Container.DataItem,"ItemUrl").ToString(), Convert.ToInt32(DataBinder.Eval(Container.DataItem,"ItemID")))  %>' data-layout="button"></div>
   ...
   <%-- <div id="fb-root"></div>
    ...
    js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.4&appId=834853613277660";
