                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlFile" runat="server">
                            <table class="FileManager_table"  border="0">
                                ...
                                <tr>
                                    <td>
                                        <mp:mojoGridView ID="dgFile" runat="server" DataKeyNames="ID" CssClass="AspNet-GridView"
                        ...
                        <asp:Panel ID="pnlNewFolder" runat="server" DefaultButton="btnNewFolder" CssClass="newfolderpanel">
                            <div class="info"  >Maximum allowed size for individual file is 5 MB. File format supported to upload the files 
                                (.gif|.jpg|.jpeg|.png|.flv|.swf|.wmv|.mp3|.mp4|.m4a|.m4v|.oga|.ogv|<br />.webma|.webmv|.webm|.wav|.fla|.tif|.asf|.asx|.avi|.mov|.mpeg|.mpg|.zip|.pdf|.doc|.docx|.xls|.xlsx|.ppt|.pptx|.pps|.csv|.txt|.htm|.html|.css) 
                                                    </div>
