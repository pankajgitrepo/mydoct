...
namespace mojoPortal.Web.ForumUI
{
    public partial class PostList :UserControl
    {
        ...
        protected string GetProfileLinkOrLabel(int userId, string userName)
        {
            ...
            return "<a  href='" + SiteRoot + "/ProfileView.aspx?userid=" + userId.ToInvariantString() + "'>" + userName + "</a>";
        ...
        private void LoadSettings()
        {
            ...
            pnlNotify.Visible = (!isSubscribedToForum) && !displaySettings.HideNotificationLinkOnPostList && false;
