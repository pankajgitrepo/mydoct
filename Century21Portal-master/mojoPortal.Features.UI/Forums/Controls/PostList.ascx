...
<asp:Panel ID="pnlNotify" runat="server" Visible="false" CssClass="forumnotify">
    ...
    <div class="modulepager">
        ...
        <a href="" class="ModulePager newpost" id="lnkNewPost" runat="server" visible="false" style="font-size:20px;"></a>
                ...
                <div class="postright">                    
                    ...
                    <div class="forumpostusername">
                        <asp:HyperLink Text="Edit" ID="Hyperlink2" ImageUrl='<%# ImageSiteRoot + "/Data/SiteImages/user_edit.png"  %>'
                            ...
                            Visible="<%# IsAdmin %>" runat="server" Enabled="false" />
                        <%--<%# GetProfileLinkOrLabel(Convert.ToInt32(Eval("UserID")), Eval("PostAuthor").ToString())%>--%>
                        <%#Eval("PostAuthor").ToString()%>
                        <span class="postduration"><%# GetCommentDuration(Convert.ToDateTime(Eval("PostDate")))%></span>
                    </div>
