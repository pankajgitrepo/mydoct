...
<asp:Panel ID="pnlEdit" runat="server" DefaultButton="btnUpdate" >
	...
	<div class="settingrow" style="display: none;">
	    ...
	    <asp:DropDownList ID="ddStartTime" runat="server" EnableTheming="false" CssClass="forminput dropdown"></asp:DropDownList>
	</div>
	<div class="settingrow" style="display: none;">
	    ...
	    <asp:DropDownList ID="ddEndTime" runat="server" EnableTheming="false" CssClass="forminput dropdown"></asp:DropDownList>
	</div>
...
<mp:SiteLabel id="SiteLabel35" runat="server" CssClass="settinglabel" ConfigKey="spacer" />
    <div class="forminput">
		...
		<asp:HyperLink ID="lnkCancel" runat="server" CssClass="art-button" style="padding-top: 7px; height: 24px;"/>&nbsp;	
